...
router.get('/:id', async (req, res) => {
  try {
    ...
    const parkingSpaceService = new ParkingSpaceService(db);
...
// GET /api/parking-spaces/:id/price
...
// PATCH /api/parking-spaces/:id/availability
